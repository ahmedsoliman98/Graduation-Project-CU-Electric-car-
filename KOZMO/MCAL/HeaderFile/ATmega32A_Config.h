 ...
 * __INTR_ATTRS : this like volatail act to note the optimization do not remove this function if we not call
...
/******************************************* define the bit on the register USRA control and statues register ************************************/
#define RXC    (7)
#define TXC    (6)
